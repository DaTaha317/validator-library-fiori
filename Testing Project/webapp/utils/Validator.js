...
sap.ui.define(
	...
	function(
		...
		var Validator = function(oController, oResourceBundle) {
			...
			this.oMessageManager = oController.getView().getModel("message") ? oController.getView().getModel("message") : sap.ui.getCore().getMessageManager();
		...
		Validator.prototype._getFallbackText = function(sKey, aParams) {
			var fallbackTexts = {
				...
				"validator.invalidDecimal": "Enter a valid decimal number (max {0} digits, {1} decimal places)",
